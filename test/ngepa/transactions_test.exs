defmodule Ngepa.TransactionsTest do
  use Ngepa.DataCase
  ...
  describe "transactions" do
    ...
    import Ngepa.TransactionsFixtures
    ...
    test "create_transaction/1 with valid data creates a transaction" do
      valid_attrs = %{message: "some message", status: "some status", success: true, amount: "some amount", transaction_code: "some transaction_code", transaction_reference: "some transaction_reference"}
    ...
    test "update_transaction/2 with valid data updates the transaction" do
      transaction = transaction_fixture()
      update_attrs = %{message: "some updated message", status: "some updated status", success: false, amount: "some updated amount", transaction_code: "some updated transaction_code", transaction_reference: "some updated transaction_reference"}
